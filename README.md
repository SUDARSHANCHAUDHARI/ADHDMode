...
[![Version](https://img.shields.io/badge/version-0.1.2-blue.svg)](https://github.com/SUDARSHANCHAUDHARI/ADHDMode/releases/tag/v0.1.2)
...
[Quick start](docs/quickstart.md) · [Examples](docs/examples.md) · [Installation](#installation) · [Modes](#response-modes) · [Configuration](docs/configuration.md) · [Release](https://github.com/SUDARSHANCHAUDHARI/ADHDMode/releases/tag/v0.1.2) · [Documentation](#documentation) · [Contributing](CONTRIBUTING.md)
...
`v0.1.2` is the current maintenance release. It makes quick mode concise and state-aware, corrects the published release checklist, and limits Codex activation guidance to observed evidence.

The repository is public and the documented remote installation paths are ready for use. Some authenticated cross-agent behavior checks remain incomplete and are tracked transparently in issue #12.
